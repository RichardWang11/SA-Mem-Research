...
Source repository: `RichardWang11/SA-Mem-Research`
Submission branch: `locomo-b-btf-reproduction-notes`
Base commit: `bdf50de` (`origin/main`, local sync on 2026-06-29)
Run date: 2026-06-24
Raw local output directory: `out/locomo_b_btf_recheck_20260624/` (not included in this branch)

## Summary

This branch documents a lightweight reproduction of the non-graph LoCoMo B/B+TF path. It keeps the submission reviewable by including reproduction notes, aggregate metrics, reusable scripts, and retrieval instrumentation. Full raw `out/` artifacts are not included.
...
## Submitted Files in This Branch
